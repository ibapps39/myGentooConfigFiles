...
alias upworld="emerge-webrsync & emaint sync --auto & emaint all & & emergej --update --deep --changed-use --with-bdeps=y @world"
...
alias vcode="vscode --no-sandbox --user-data-dir=/home/ian/VSCodeData"
...
# function track {export $1=""}
alias checkProgress="mark there && trail -f $there | grep .*]"
alias go_ProgrammingProjects="cd /home/ian/ProgrammingProjects"
